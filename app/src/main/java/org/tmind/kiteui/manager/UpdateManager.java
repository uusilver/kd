package org.tmind.kiteui.manager;
...
{
	private final static String TAG="UpdateManager.class";
	/* 下载中 */
	private static final int DOWNLOAD = 1;
	/* 下载结束 */
	private static final int DOWNLOAD_FINISH = 2;
	/* 保存解析的XML信息 */
	RemoteUpdateModel remoteUpdateModel;
	/* 下载保存路径 */
	...
	public UpdateManager(Context context, RemoteUpdateModel remoteUpdateModel, int currentVersionCode)
	{
		this.mContext = context;
		this.remoteUpdateModel = remoteUpdateModel;
		...
		public void run()
		{
			try
			{
				...
				if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED))
				{
					...
					URL url = new URL(remoteUpdateModel.getUrl());
					// 创建连接
					...
					File apkFile = new File(mSavePath, remoteUpdateModel.getInstallName());
					...
					Toast.makeText(mContext, "无法检测到SD卡，安装更新取消",Toast.LENGTH_LONG).show();
				}
